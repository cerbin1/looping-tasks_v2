...
const ids = [0, 1]
    ...
    //todo na koncu to wsadzic do osobnego pliku z danymi albo do klasy jakiejs statycznej itp
    asd = [{
        links: [
            {
                name: "Quick Notes",
    ...
    getElements(number) {
        let asdd = [["Organizacja maila głównego"], ["Organizacja maila głównego"]]
        console.log([asdd[0]])
        // console.log([this.asd[0]])
        let array = [];
        // this.asd[number].forEach(element => array.push({name: element, isClicked: false}));
        this.asd[number].tasks.forEach(taskName => array.push(new SingleTask(taskName)));
        return array;
        /*        return [{name: "Organizacja maila głównego", isClicked: false},
                ...
                [
                    ...
                    },
                    {
                        ...
                        elements: [
                            ...
                            {
                                name: "Opłacić media, abonamenty i kredyty, pobrać faktury i potwierdzenia płatności, zapisać kwoty",
                                isClicked: false
                            },
                            ...
                            {
                                name: "Zaktualizować kwoty w arkuszu Oszczędności po opłaceniu wszystkiego na ten miesiąc",
                                isClicked: false
                            },
